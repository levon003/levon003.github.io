...
Articles/blogposts:
 ...
 - "An Audacious Plan to Halt the Internet’s Enshittification and Throw It Into Reverse" by Cory Doctorow: <https://pluralistic.net/2023/08/27/an-audacious-plan-to-halt-the-internets-enshittification-and-throw-it-into-reverse/>
 - "What Actually Makes You Senior" by Matheus Lima: <https://terriblesoftware.org/2025/11/25/what-actually-makes-you-senior/>
...
- "Higher-order truths about chmess" by Daniel Dennett: <https://personal.lse.ac.uk/robert49/teaching/ph445/notes/dennett.pdf>
- "Prediction-powered inference" by Anastasios Angelopoulos et al.: <https://www.science.org/doi/full/10.1126/science.adi6000>
...
Books:
 ...
 - "Patterns, Predictions, and Actions: Foundations of Machine Learning" by Moritz Hardt and Benjamin Recht: <https://mlstory.org/>

Datasets/resources:
 - NIH collection of free vector graphics for presentations: <https://bioart.niaid.nih.gov/>
 - EleutherAI's Deep Learning Cookbook: <https://github.com/EleutherAI/cookbook>
