...
The output is a [YAML file](https://github.com/levon003/levon003.github.io) versioned in this blog's public GitHub repository, which a Jekyll template consumes as site data. GitHub Actions runs nightly to refresh the YAML file.
