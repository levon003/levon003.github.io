...
Why is it useful to think about the problem this way? Because the repeated down-under deal in step 11 is the [Josephus problem](https://en.wikipedia.org/wiki/Josephus_problem).
