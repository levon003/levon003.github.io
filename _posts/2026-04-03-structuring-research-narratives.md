...
He break down the story of a research abstract into a set of "sentence purposes", and several of them strongly resemble the framework above. But, he makes an important point: there's nothing sacred about a particular narrative structure.
...
Fiesler is completely correct: "there's a gap" is not a compelling justification for doing the research.
It _is_ good to notice when there are gaps, but you should first ask yourself: _why_ is there a gap?
Use the answer to that question as your motivation instead.
